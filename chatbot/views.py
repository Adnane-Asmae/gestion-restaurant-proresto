...
def process_user_message(message):
    ...
    if 'menu' in message or 'plats' in message or 'que proposez-vous' in message:
        return afficher_menu(plats_disponibles)
    elif 'commander' in message or 'je veux' in message or 'je prendrai' in message:
        return traiter_commande(message, plats_disponibles)
    elif 'tables' in message or 'table' in message:
        return afficher_tables(tables_disponibles)
...
def traiter_commande(message, plats):
    plats_commandes = []
    ...
    table_numero = extraire_numero_table(message)
...
def extraire_numero_table(message):
    mots = message.split()
